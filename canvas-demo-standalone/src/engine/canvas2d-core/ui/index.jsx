    ...
    const render = async () => {
      ...
      if (previewKind === "pdf") {
        ...
        if (!GlobalWorkerOptions.workerSrc) {
          GlobalWorkerOptions.workerSrc = resolveVendorAssetUrl("assets/vendor/pdfjs-dist/pdf.worker.mjs");
        }
        const loadingTask = getDocument({
          data: bytes,
          useWorkerFetch: false,
          isEvalSupported: false,
          cMapUrl: resolveVendorAssetUrl("assets/vendor/pdfjs-dist/cmaps/"),
          standardFontDataUrl: resolveVendorAssetUrl("assets/vendor/pdfjs-dist/standard_fonts/"),
          wasmUrl: resolveVendorAssetUrl("assets/vendor/pdfjs-dist/wasm/"),
        });
